...
class TestPluginUtils(TestCase):
    ...
    def test_schema_class(self):
        ...
        self.assertEqual(
            info["qualname"], "flask_open_spec.tests.schemas.schemas.GistSchema"
        )
    ...
    def test_schema_obj(self):
        ...
        self.assertEqual(
            info["qualname"], "flask_open_spec.tests.schemas.schemas.gistObj1"
        )
    ...
    def test_schema_func(self):
        ...
        self.assertEqual(
            info["qualname"], "flask_open_spec.tests.schemas.schemas.get_schema"
        )
    ...
    def test_schema_str(self):
        schema = "flask_open_spec.tests.schemas.schemas.GistSchema"
        info = utils.get_schema_info(schema)
        self.assertEqual(info["name"], "GistSchema")
        self.assertEqual(
            info["qualname"], "flask_open_spec.tests.schemas.schemas.GistSchema"
    ...
    def test_schema_str2(self):
        schema = "flask_open_spec.tests.schemas.schemas.gistObj1"
        info = utils.get_schema_info(schema)
        self.assertEqual(info["name"], "gistObj1")
        self.assertEqual(
            info["qualname"], "flask_open_spec.tests.schemas.schemas.gistObj1"
    ...
    def test_schema_str3(self):
        schema = "flask_open_spec.tests.schemas.schemas.get_schema"
        kwargs = {"type": "class", "name": "gist"}
